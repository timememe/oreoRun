(function() {
    ...
    const translations = {
        en: {
            gameTitle: "Instruction",
            tutorialText: "Avoid obstacles and collect 3 arches! \n Use arrow keys to switch lanes.",
        ...
        ru: {
            ...
            tutorialText: "Избегайте препятствий и собирите 3 арки! \n Используйте стрелки для смены полосы.",
        ...
        ge: { // Грузинский
            gameTitle: "ინსტრუქცია",
            tutorialText: "მოარიდეთ დაბრკოლებებს და შეაგროვეთ 3 თაღი! \n გამოიყენეთ ისრის ღილაკები ზოლის შესაცვლელად.",
            startGame: "თამაშის დაწყება",
            victory: "თქვენ გაიმარჯვეთ!",
            defeat: "თამაში დასრულდა",
            restartGame: "თავიდან დაწყება",
            score: "ქულა: ",
            backButtonText: "უკან"
        },
        kz: { // Казахский
            gameTitle: "Нұсқаулық",
            tutorialText: "Кедергілерден аулақ болыңыз және 3 арканы жинаңыз! \n Жолды ауыстыру үшін бағыттауыш пернелерді қолданыңыз.",
        ...
        az: { // Узбекский
            gameTitle: "Ko'rsatma",
            tutorialText: "To'siqlardan qoching va 3 ta arkani yig'ing! \n Chiziqlarni o'zgartirish uchun kamonlardan foydalaning.",
    ...
    const backURL = `${baseURL}back.png`; 
    ...
    function preloadImages(callback) {
        ...
        images.back.src = backURL;
        images.back.onload = incrementLoad;
        images.back.onerror = handleImageError;
    ...
    function initGame() {
        ...
        gameSpeed = 0.025; // Сбрасываем скорость
